...
Create an image showing two complementary Zen states:
- Samurai Mode — attention as a sharp, singular point, like a blade of focus  
- Monk Mode — attention released into a balanced, infinite field  

The image should be symbolic, abstract, and energetic, not literal martial arts. Show the tension between contraction and release, precision and openness.
